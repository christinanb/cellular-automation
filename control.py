...
=======
>>>>>>> 06d76e98b7b824bae9cc9ad397bc7bc754c0e8bd
    ...
    def find_optimal_neighbor(self, pedestrian):
        ...
        for i, neighbor in enumerate(pedestrian.cell.get_avail_neighbors()):
            neighbor_cost = neighbor.static_cost + avail_neighbor_pedestrian_costs[i] + 0.01*np.linalg.norm(neighbor.loc - pedestrian.cell.loc)
